...
var wipeAnimation2 = new TimelineMax()
	.fromTo(".section-container-2 .panel-1 .img-1", 2, {
		width: "60%"
	}, {
		width: "4000%",
		opacity: "0",
	...
	.fromTo(".section-container-2 .panel-2 .img-3", 0.1, {
		width: "44%"
	}, {
		width: "120%",
		ease: Linear.easeIn
	...
	.fromTo(".section-container-2 .panel-1", 0.001, {
		opacity: "1"
	}, {
		opacity: "0",
...
var wipeAnimation9 = new TimelineMax()
	.fromTo(".section-container-9 .panel-2 .img-1", 0.01, {
		opacity: "0"
	}, {
		opacity: "1",
		ease: Power1.easeIn
	...
	.fromTo(".section-container-9 .panel-2 .img-1", 1.2, {
		width: "2000%"
	}, {
		width: "90%",
		ease: Linear.easeIn
	})
	.fromTo(".section-container-9 .panel-1 .vid-1", 1.2, {
		width: "140%"
	}, {
		width: "80%",
		ease: Linear.easeIn
...
$(function() { // Section 1
	...
	$(".see-it-btn").on("click", function() {
		...
		setTimeout(function() {
			$([document.documentElement, document.body]).animate({
				scrollTop: $('.section-container-3').offset().top
			}, 10);
		}, 5);
		setTimeout(function() {
			$([document.documentElement, document.body]).animate({
	...
	$(".item .arrow-i-down").on("click", function() {
		$([document.documentElement, document.body]).animate({
			scrollTop: $('.section-container-2a').offset().top - 100
		}, 500);
	});
	...
	if (ww > 767) {
		...
		$(".option-replay").on("click", function() {
			...
			setTimeout(function() {
				$(".option-replay").removeClass("isclicked");
			}, 400);
		});
	} else {
		$(".volume").on("click", function() {
	...
	$('#marqueeCarousel').on('slide.bs.carousel', function onSlide(ev) {
		setTimeout(function() {
			$("a.carousel-control-next").removeClass("isactive");
			$("a.carousel-control-prev").removeClass("isactive");
		}, 600);
		...
		switch (id) {
			case "1":
				...
				setTimeout(function() {
					$("a.carousel-control-next").addClass("isactive");
					$("a.carousel-control-prev").addClass("isactive");
				}, 4000);
	...
	if (ww <= 768) {
		...
		$('.bell-container.isactive .bell').on('mouseover', function() {
			if ($('.bell-container').hasClass("isclosed")) {} else {
				$('.bell-container').addClass("isactive");
			}
		});
		...
		$('.bell-container-static.isactive .bell').on('mouseover', function() {
			if ($('.bell-container-static').hasClass("isclosed")) {} else {
				$('.bell-container-static').addClass("isactive");
			}
		});
